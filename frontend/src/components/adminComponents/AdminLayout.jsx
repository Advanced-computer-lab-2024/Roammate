...
const AdminLayout = () => {
    ...
    const [buttons, setButtons] = React.useState(['Users', 'Registrations', 'Complaints']);
            ...
            <Box sx={{
                ...
                <Box variant="text" aria-label="text primary button group" sx={{
                    ...
                    {buttons.map((button, index) => (
                        <Button variant="text" key={index} onClick={() => setActiveButton(button)}
                            sx={{

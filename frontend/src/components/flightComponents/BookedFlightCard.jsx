...
import BookedFlightDetails from "../touristComponents/BookedFlightDetails";

function BookedFlightCard({ bookingCode, flightData }) {
    ...
    return (
        ...
        >
            ...
            <AccordionDetails>
                <BookedFlightDetails bookingCode={bookingCode} flightData={flightData} />
            </AccordionDetails>
        </Accordion>
    );
}
